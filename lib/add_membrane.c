...
int anchor2defined(PROT *prot_p, VECTOR *pos) {
    ...
    VECTOR vec_axis;
    VECTOR pos_i, pos_j; //, pos_k; // Commented out by Salah on Dec. 2015 (not used)
    ...
    // pos_k = vector_normalize(vector_vminusv(pos[3],pos[0])); // Commented out by Salah on Dec. 2015 (not used)
