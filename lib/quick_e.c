...
//static float cutoff_near2 = VDW_CUTOFF_NEAR * VDW_CUTOFF_NEAR; // Commented out by Salah on Dec. 2015 (not used)
//static float cutoff_far2  = VDW_CUTOFF_FAR  * VDW_CUTOFF_FAR; // Commented out by Salah on Dec. 2015 (not used)
